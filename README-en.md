...
| Tool | Function |
| :--- | :--- |
| [**mobywatel-downloader-userscript.js**](./mobywatel-downloader-userscript.js) | Downloads the entire repository (Android or iOS) as a clean ZIP file directly from your browser. |
...
> [!IMPORTANT] Notice for Chrome users (Manifest V3):
...
2. In this repository, find the [mobywatel-downloader-userscript.js](./mobywatel-downloader-userscript.js) file, click the **"Raw"** button, and then confirm the script installation in the extension window.
